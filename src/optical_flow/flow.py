...
def compute_flow(
    ...
    """Compute dense optical flow for motion masking.

    This pipeline is intentionally affine-only (no per-pixel flow warping) to
    keep latency predictable for streaming use cases.
    """
    flow = None
